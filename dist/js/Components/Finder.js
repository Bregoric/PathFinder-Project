...
class Finder {
    constructor(element) {
        ...
        // start at step 1
        thisFinder.step = 1;
        thisFinder.grid = {} // macierz aktywnych / niekatywntch komorek
    ...
    toggleField(fieldElem) {
        ...
        const field = {
            row: parseInt(fieldElem.getAttribute('data-row')), //wymuszenie aby odczytany atrybut był intem
        ...
        if (thisFinder.grid[field.row][field.col]) {
            ...
            fieldElem.classList.remove(classNames.finder.selected);
        } else {
            ...
            fieldElem.classList.add(classNames.finder.selected);
        }
    }
}
